...
Histogram sam w sobie, prezentuje ilość próbek w danym zakresie na osi X, można więc to interpretować w ten sposób, że jest to wizualne przedstawienie prawdopodobieństwa wystąpienia próbki w danym zakresie. W sygnale gaussowskim, występuje rozkład normalny i średnia wartość sygnału opiewa się w okolicy 0, dlatego też, histogram wygląda w taki sposób, że największe słupki występują na środku wykresu, czyli w zakresach na osi X znajdujących się najbliżej zera. 
